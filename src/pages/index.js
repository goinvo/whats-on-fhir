    ...
    <Layout>
      <main style={pageStyles}>
        ...
        <div style={containerStyles}>
          ...
          {prompts.map(prompt => (
            <div key={prompt.title} style={{ ...listItemStyles }}>
