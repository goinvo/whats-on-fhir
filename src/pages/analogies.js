  ...
  return (
    <Layout>
      <div style={{...containerStyles}}>
        ...
        <div style={{...analogyStyles}}>
          {/* <Heading as='h2' size='lg'>Extensions</Heading> */}
          <p style={{ marginTop: '.5rem' }}>To be continued...</p>
        </div>
      </div>
    </Layout>
  )
